...
<body>
    <h3 class="text-center mt-5 text-primary">ADD NEW TAG</h3>
     <div class="wrap">
     <form action="index.php" method="post">
        <div>
            <label for="" class="text-dark">NAME TAG:</label>
            <input class="form-control border-[2px] border-solid border-black h-[37px] rounded-[5px] min-w-[300px]"  type="text" name="name_tag" >
